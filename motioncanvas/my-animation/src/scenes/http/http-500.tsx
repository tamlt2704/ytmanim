...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={title} text={'500'} fill={RED} fontFamily={CODE_FONT} fontSize={140} fontWeight={800} y={-500} opacity={0} />);
  view.add(<Txt ref={subtitle} text={'Internal Server Error'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={52} y={-380} opacity={0} />);
  ...
  view.add(
    <Rect ref={codeBox} width={700} height={350} y={50} radius={24} fill={TERMINAL_BG} stroke={RED} lineWidth={4} opacity={0} scale={0.8}>
      ...
      <Txt text={'Something broke on\nthe server side.'} fill={'#8b949e'} fontFamily={CODE_FONT} fontSize={28} y={60} textAlign={'center'} lineHeight={44} />
    </Rect>
  );
