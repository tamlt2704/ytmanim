...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={recap} text={'Your eyes just lied 3 times!'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={34} fontWeight={700} y={130} opacity={0} />);

  const topics = createRef<Txt>();
  view.add(<Txt ref={topics} text={'📏 Müller-Lyer\n🔵 Ebbinghaus\n♟️ Checker Shadow'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={30} y={310} textAlign={'center'} lineHeight={50} opacity={0} />);

  const follow = createRef<Txt>();
  view.add(<Txt ref={follow} text={'More illusions coming soon! 🔥'} fill={ORANGE} fontFamily={TITLE_FONT} fontSize={36} y={500} opacity={0} />);
