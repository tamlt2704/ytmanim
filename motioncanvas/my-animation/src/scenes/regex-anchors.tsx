...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={subtitle} text={'Anchors'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={44} y={-490} opacity={0} />);
      ...
      <Rect ref={cards} width={750} height={120} y={-220} radius={16} fill={TERMINAL_BG} stroke={PURPLE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'^hello'} fill={PURPLE} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Starts with hello'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={-70} radius={16} fill={TERMINAL_BG} stroke={PURPLE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'world$'} fill={PURPLE} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Ends with world'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={80} radius={16} fill={TERMINAL_BG} stroke={ACCENT_COLOR} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'\\bword\\b'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Word boundary'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
