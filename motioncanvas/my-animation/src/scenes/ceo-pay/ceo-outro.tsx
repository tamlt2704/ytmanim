...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={recap} text={'CEO pay per second 💰'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={34} fontWeight={700} y={130} opacity={0} />);

  const topics = createRef<Txt>();
  view.add(<Txt ref={topics} text={'🍎 Cook $3.13  🔍 Pichai $7.17\n📦 Jassy $0.93  🪟 Nadella $1.54\n👑 Tan $5.14  🧑💻 You $0.002'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} y={280} textAlign={'center'} lineHeight={42} opacity={0} />);

  const follow = createRef<Txt>();
  view.add(<Txt ref={follow} text={'More money facts coming! 🔥'} fill={ORANGE} fontFamily={TITLE_FONT} fontSize={34} y={430} opacity={0} />);
