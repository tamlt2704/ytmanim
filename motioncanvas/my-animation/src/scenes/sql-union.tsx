...
export default makeScene2D(function* (view) {
  ...
  yield* all(lines[0].opacity(1, 0.3), lines[0].text('SELECT name FROM customers|UNION|SELECT name FROM suppliers;', 0.4));
  yield* all(lines[1].opacity(1, 0.3), lines[1].text('Stacks result sets\nvertically 📚', 0.4));
  yield* all(lines[2].opacity(1, 0.3), lines[2].text('UNION ALL keeps duplicates', 0.4));
