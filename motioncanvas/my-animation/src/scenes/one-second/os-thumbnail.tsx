...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt text={'⏱️'} fontSize={280} y={-380} />);
  view.add(<Txt text={'1 SECOND'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={140} fontWeight={900} y={-120} letterSpacing={10} />);
  view.add(<Txt text={'on the'} fill={'#8b949e'} fontFamily={TITLE_FONT} fontSize={70} fontWeight={900} y={10} />);
  view.add(<Txt text={'INTERNET'} fill={ACCENT_COLOR} fontFamily={TITLE_FONT} fontSize={140} fontWeight={900} y={140} letterSpacing={10} />);
  view.add(<Txt text={'The numbers are\ninsane 🤯'} fill={'#8b949e'} fontFamily={CODE_FONT} fontSize={34} y={310} textAlign={'center'} lineHeight={50} />);
