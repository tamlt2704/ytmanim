...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={title} text={'View Trans.'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={80} fontWeight={800} y={-580} opacity={0} />);
  view.add(<Txt ref={subtitle} text={'Page Transitions'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={44} y={-490} opacity={0} />);
  
      <Rect ref={cards} width={750} height={120} y={-220} radius={16} fill={TERMINAL_BG} stroke={ACCENT_COLOR} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'view-transition-name'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Name elements'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={-70} radius={16} fill={TERMINAL_BG} stroke={GREEN} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'::view-transition'} fill={GREEN} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Style the transition'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={80} radius={16} fill={TERMINAL_BG} stroke={ORANGE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'Smooth page swaps'} fill={ORANGE} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Built-in animations!'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
