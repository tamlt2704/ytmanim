...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={title} text={'@layer'} fill={PURPLE} fontFamily={CODE_FONT} fontSize={80} fontWeight={800} y={-580} opacity={0} />);
  view.add(<Txt ref={subtitle} text={'Cascade Layers'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={44} y={-490} opacity={0} />);
  
      <Rect ref={cards} width={750} height={120} y={-220} radius={16} fill={TERMINAL_BG} stroke={PURPLE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'@layer base, theme'} fill={PURPLE} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Define layer order'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={-70} radius={16} fill={TERMINAL_BG} stroke={GREEN} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'@layer base {...}'} fill={GREEN} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Add styles to layer'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={80} radius={16} fill={TERMINAL_BG} stroke={ORANGE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'Control specificity'} fill={ORANGE} fontFamily={CODE_FONT} fontSize={32} fontWeight={800} x={-220} />
        <Txt text={'Without !important'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={22} x={80} />
      </Rect>
