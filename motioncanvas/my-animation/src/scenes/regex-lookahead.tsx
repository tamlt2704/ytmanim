...
export default makeScene2D(function* (view) {
  ...
  view.add(<Txt ref={title} text={'(?=)'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={90} fontWeight={800} y={-580} opacity={0} />);
  view.add(<Txt ref={subtitle} text={'Lookahead'} fill={TEXT_COLOR} fontFamily={TITLE_FONT} fontSize={44} y={-490} opacity={0} />);
      ...
      <Rect ref={cards} width={750} height={120} y={-220} radius={16} fill={TERMINAL_BG} stroke={ACCENT_COLOR} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'\\d(?=px)'} fill={ACCENT_COLOR} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Digit before px'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={-70} radius={16} fill={TERMINAL_BG} stroke={RED} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'\\d(?!px)'} fill={RED} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Digit NOT before px'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
      <Rect ref={cards} width={750} height={120} y={80} radius={16} fill={TERMINAL_BG} stroke={ORANGE} lineWidth={3} opacity={0} scale={0.8}>
        <Txt text={'Lookahead'} fill={ORANGE} fontFamily={CODE_FONT} fontSize={36} fontWeight={800} x={-220} />
        <Txt text={'Checks without consuming'} fill={TEXT_COLOR} fontFamily={CODE_FONT} fontSize={24} x={80} />
      </Rect>
